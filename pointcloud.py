...
python3.11 -m venv ~/open3d-env-py311
source ~/open3d-env-py311/bin/activate
pip install --upgrade pip
pip install open3d numpy pillow scipy matplotlib pyyaml opencv-python pupil-apriltags
